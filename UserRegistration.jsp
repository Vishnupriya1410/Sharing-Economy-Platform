...
<body style="background-image: url('images/ulog.jpg');">
	<br><br><br>
	<h1 align="center"   style="font-family:'Algerian';font-size:40px;color:black;text-shadow: 3px 2px white;">User Registration
 <br>
   </h1>
<small style="font-family: Cambria;font-size: 20px;font-style: italic;color: black;"><center>Please fill all the Mandatory fields Marked
	...
	<form name="form" action="UserRegistrationController"  class="contact-form" method="post"
		onsubmit="return validate()">

		<table align="center">
<br><br><br>
		<!-- 	<tr>
				<th colspan="2"><h2>User Registration</h2></th>
			</tr>
			 -->
			...
			<tr>
				...
				<td><input type="text" name="FirstName"
					...
					title="Must contain at least one uppercase and lowercase letter, and no numbers"></td>
			</tr>
			...
			<tr>
				...
				<td><select name="Gender" class="dropdown">
						<option value="select" style=" font-size: 18px;font-family: Cambria;"><b>Select</b></option>
			...
			<tr>
				<td style="font-family:'Constantia';font-size: 35px;color:black;">User Id<b style="color: red">* </b></td>
