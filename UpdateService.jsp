...
<body style="background-image: url('images/imgg8.jpg'); background-repeat: no-repeat; background-size: 100%">
	...
	<br><br><br><br>
	<br><br><br><br>
	<h1 align="center" style="font-family:'Algerian';font-size:40px;color:#5c00e6;text-shadow: 4px 3px white;">Update Service</h1>
	<div class="ex">
		<form action="UpdateServiceController" method="post">
			  ...
			  <tr>
				...
				<tr></tr>
					<tr>
					<td colspan="2" align="center"><input type="submit" value="UpdateService" class="button button1"/></td>
					</tr>
			</table>
